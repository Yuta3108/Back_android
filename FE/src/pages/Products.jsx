                    ...
                    <table className="table-auto border-collapse w-full max-w-6xl  text-sm">
                        <thead>
                            <tr className="bg-[#c8a97e] text-white">
                                ...
                                <th className="border border-[#d9cbb4] px-4 py-2">Tên sản phẩm</th>
                                <th className="border border-[#d9cbb4] px-4 py-2">Phân loại</th>
                                <th className="border border-[#d9cbb4] px-4 py-2">Giá theo size</th>
                                <th className="border border-[#d9cbb4] px-4 py-2">Ngày tạo</th>
                                <th className="border border-[#d9cbb4] px-4 py-2 text-center">Hành động</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            {Array.isArray(products) && products.map(product => (
                                <tr key={product.id} className="hover:bg-[#f5eee4]">
                                    <td className="border border-[#d9cbb4] px-4 py-2">{product.id}</td>
                                    <td className="border border-[#d9cbb4] px-4 py-2">{product.name}</td>
                                    <td className="border border-[#d9cbb4] px-4 py-2">{product.category}</td>
                                    ...
                                    <td className="border border-[#d9cbb4] px-4 py-2">{product.createdAt}</td>
